...
class BaseModel(nn.Module):
    def __init__(self, backbone, n_channels, num_classes, weights, **kwargs):
        super(BaseModel, self).__init__()

    def get_cam_layer(self):
        return 'backbone.layer4' #resnet18、arlnet18、AW_ARL
        # return 'backbone.ARL4' #resnet18、arlnet18、AW_ARL
        # return 'backbone.slice5' #vgg16bn
